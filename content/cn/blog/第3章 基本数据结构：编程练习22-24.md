...
# 《Python 数据结构与算法分析(第2版)》读书笔记之{% post_link "第3章 基本数据结构"  "第3章 基本数据结构" %}：编程练习22-24
## 1 编程练习22
### 1.1 要求
使用链表实现栈
### 1.2 代码
...
## 4 设计和实现一个试验，比较用链表实现的列表与 Python 列表的性能
...
## 5 设计和实现一个试验，比较基于 Python 列表的栈和队列与相应链表实现的性能
...
## 9 为队列创建一个实现，使得添加操作和移除操作的平均时间复杂度是O(1)

见[23-使用链表实现队列](#23-使用链表实现队列)，另外，也可以使用双向链表来实现。

<a href="{% post_path '第3章 基本数据结构：编程练习' %}#3-直接的中序计算">3 直接的中序计算</a>